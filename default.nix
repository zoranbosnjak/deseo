...
, deepseq-generics, filepath, HUnit, megaparsec, mtl
, parser-combinators, QuickCheck, stdenv, test-framework
, test-framework-hunit, test-framework-quickcheck2, xml
}:
mkDerivation {
  pname = "deseo";
  version = "1.5.0";
  ...
  libraryHaskellDepends = [
    ...
    parser-combinators QuickCheck xml
  ];
  testHaskellDepends = [
